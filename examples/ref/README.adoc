...
https://github.jpl.nasa.gov/bocchino/fprime-layout/wiki/Topology-Input[FPL input format].

** `json`: Layout files in the
https://github.jpl.nasa.gov/bocchino/fprime-layout/wiki/Layout-Output[FPL output format].
